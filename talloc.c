...
#else
#  define DBG_INITIALIZE_NULL = NULL
#endif
...
#define TALLOC_MAGIC_NON_RANDOM                                  \
      (~TALLOC_FLAG_MASK &                                       \
       (TALLOC_MAGIC_BASE + (TALLOC_BUILD_VERSION_MAJOR << 24) + \
        (TALLOC_BUILD_VERSION_MINOR << 16) + (TALLOC_BUILD_VERSION_RELEASE << 8)))
...
static void talloc_log_to_stderr(char const *message);
static void talloc_log(const char *fmt, ...) PRINTF_ATTRIBUTE(1, 2);
static void talloc_abort(const char *reason);

static struct talloc_chunk *talloc_chunk_from_ptr(const void *ptr);

static inline bool talloc_memlimit_check(struct talloc_memlimit *limit, size_t size) __attribute__((pure));
...
_PUBLIC_ int
talloc_version_major(void)
{
      return TALLOC_VERSION_MAJOR;
}

_PUBLIC_ int
talloc_version_minor(void)
{
      return TALLOC_VERSION_MINOR;
}

_PUBLIC_ int
talloc_test_get_magic(void)
{
      return (int)talloc_magic;
}

static inline void
_talloc_chunk_set_free(struct talloc_chunk *tc, const char *location)
{
      /*
...
static inline void
_talloc_chunk_set_not_free(struct talloc_chunk *tc)
{
      /*
...
static void
talloc_log_to_stderr(char const *message)
{
      fputs(message, stderr);
      fflush(stderr);
}

PRINTF_ATTRIBUTE(1, 0) static void
...
#  define SHOW_STACKTRACE()                                                   \
      __extension__({                                                       \
            __attribute__((unused)) size_t dummy;                           \
            void  *arr[128];                                                \
            size_t num = backtrace(arr, 128);                               \
            fflush(stderr);                                                 \
            fsync(2);                                                       \
            dummy = write(2, "<<< FATAL ERROR >>>\n    STACKTRACE:\n", 36); \
...
talloc_lib_init(void)
{
      ...
      if (atomic_flag_test_and_set(&flg)) {
            fprintf(stderr, "D'OH! Already initialized. Sigh.\n");
            fflush(stderr);
            return;
      }
#endif
      ...
      talloc_set_log_fn(talloc_log_to_stderr);
      talloc_set_abort_fn(talloc_log_to_stderr);

      /* Nuts to all of this. I'll just abuse the standard C++ library's
       * "random device" RNG. */
#if 0
...
#elif defined(HAVE_GETAUXVAL) && defined(AT_RANDOM)
      uint8_t *p;
      /*
...
#endif
      {
            extern uint32_t cxx_random_device_get_random_val(void) __attribute__((warn_unused_result));
            extern uint32_t cxx_random_engine_get_random_val(void) __attribute__((warn_unused_result));

            random_value = cxx_random_device_get_random_val();;
#if 0
#if defined(HAVE_LRAND48)
            srand48((long)((uintptr_t)talloc_set_log_fn ^ getpid() ^ time(NULL)));
...
static void
talloc_abort(const char *reason)
{
      if (!talloc_abort_fn)
            TALLOC_ABORT(reason);
...
static void
talloc_abort_access_after_free(void)
{
      talloc_abort("Bad talloc magic value - access after free");
}

static void
talloc_abort_unknown_value(void)
{
 ...
 */
_PUBLIC_ const char *
talloc_parent_name(const void *ptr)
{
      struct talloc_chunk *tc = talloc_parent_chunk(ptr);
...
static inline struct talloc_chunk *
talloc_chunk_from_pool(struct talloc_pool_hdr *h)
{
...
static inline void *
tc_pool_end(struct talloc_pool_hdr *pool_hdr)
{
...
tc_pool_space_left(struct talloc_pool_hdr *pool_hdr)
{
...
static inline void *
tc_next_chunk(struct talloc_chunk *tc)
{
      return (char *)tc + TC_ALIGN16(TC_HDR_SIZE + tc->size);
}

static inline void *
tc_pool_first_chunk(struct talloc_pool_hdr *pool_hdr)
{
      struct talloc_chunk *tc = talloc_chunk_from_pool(pool_hdr);
...
static inline void
tc_invalidate_pool(struct talloc_pool_hdr *pool_hdr)
{
...
static inline struct talloc_chunk *
tc_alloc_pool(struct talloc_chunk *parent, size_t size, size_t prefix_len)
{
      ...
      tcc    = (union talloc_chunk_cast_u){.ptr = ((uint8_t *)pool_hdr->end) + prefix_len};
      result = tcc.chunk;
...
static inline void *
__talloc(const void *context, size_t size, struct talloc_chunk **tc)
{
...
static inline void *
_talloc_pool(const void *context, size_t size)
{
      struct talloc_chunk *tc          DBG_INITIALIZE_NULL;
      struct talloc_pool_hdr *pool_hdr DBG_INITIALIZE_NULL;
      void                            *result;
...
_PUBLIC_ void *
talloc_pool(const void *context, size_t size)
{
...
_PUBLIC_ void *
_talloc_pooled_object(const void *ctx,
                      size_t      type_size,
 ...
 */
_PUBLIC_ void
_talloc_set_destructor(const void *ptr, int (*destructor)(void *))
{
 ...
 */
_PUBLIC_ int
talloc_increase_ref_count(const void *ptr)
{
 ...
 */
static int
talloc_reference_destructor(struct talloc_reference_handle *handle)
{
 ...
 */
static inline void
_tc_set_name_const(struct talloc_chunk *tc, const char *name)
{
      tc->name = name;
}
 ...
 */
static inline void *
_talloc_named_const(const void *context, size_t size, const char *name)
{
      void *ptr;
      struct talloc_chunk *tc DBG_INITIALIZE_NULL;
...
_talloc_reference_loc(const void *context, const void *ptr, const char *location)
{
      ...
      tc     = talloc_chunk_from_ptr(ptr);
      handle = _talloc_named_const(context, sizeof(struct talloc_reference_handle),
...
static inline void
_tc_free_poolmem(struct talloc_chunk *tc, const char *location)
{
      struct talloc_pool_hdr *pool;
...
static inline void
_tc_free_children_internal(struct talloc_chunk *tc, void *ptr, const char *location);
 ...
 */
static inline int
_tc_free_internal(struct talloc_chunk *tc, const char *location)
{
      void *ptr_to_free;
 ...
 */
static inline int
_talloc_free_internal(void *ptr, const char *location)
{
      struct talloc_chunk *tc;
 ...
 */
static void *
_talloc_steal_internal(const void *new_ctx, const void *ptr)
{
 ...
 */
_PUBLIC_ void *
_talloc_steal_loc(const void *new_ctx, const void *ptr, const char *location)
{
      struct talloc_chunk *tc;
 ...
 */
static inline int
talloc_unreference(const void *context, const void *ptr)
{
      struct talloc_chunk            *tc = talloc_chunk_from_ptr(ptr);
      struct talloc_reference_handle *h;
 ...
 */
static inline const char *tc_set_name_v(struct talloc_chunk *tc, const char *fmt, va_list ap)
    PRINTF_ATTRIBUTE(2, 0);
 ...
 */
static inline const char *
__talloc_get_name(const void *ptr)
{
      struct talloc_chunk *tc = talloc_chunk_from_ptr(ptr);
 ...
 */
_PUBLIC_ void *
talloc_check_name(const void *ptr, const char *name)
{
      const char *pname;
      if (unlikely(ptr == NULL))
            return NULL;
...
static void
talloc_abort_type_mismatch(const char *location, const char *name, const char *expected)
{
      const char *reason;

      reason = talloc_asprintf(NULL, "%s: Type mismatch: name[%s] expected[%s]", location,
 ...
 */
_PUBLIC_ void *
_talloc(const void *context, size_t size)
{
      struct talloc_chunk *tc;
 ...
 */
_PUBLIC_ void *
talloc_named_const(const void *context, size_t size, const char *name)
{
 ...
 */
_PUBLIC_ int
_talloc_free(void *ptr, const char *location)
{
      struct talloc_chunk *tc;
 ...
 */
_PUBLIC_ void *
_talloc_realloc(const void *context, void *ptr, size_t size, const char *name)
{
      struct talloc_chunk    *tc;
      void                   *new_ptr;
      bool                    malloced = false;
      ...
      if (pool_hdr) {
            ...
            if (tc->limit && (size > old_size)) {
                  if (!talloc_memlimit_check(tc->limit, (size - old_size))) {
                        _talloc_chunk_set_not_free(tc);
                        errno = ENOMEM;
                        return NULL;
                  }
 ...
 */
_PUBLIC_ void *
_talloc_move(const void *new_ctx, const void *_pptr)
{
...
static inline size_t
_talloc_total_mem_internal(const void                *ptr,
                           ...
                           struct talloc_memlimit    *new_limit)
{
      ...
      if (type == TOTAL_MEM_LIMIT && tc->limit != NULL && tc->limit != old_limit &&
          tc->limit->parent == tc)
    ...
    void *private_data)
{
      ...
      for (c = tc->child; c; c = c->next) {
            if (c->name == TALLOC_MAGIC_REFERENCE) {
                  ...
                  talloc_report_depth_cb(TC_PTR_FROM_CHUNK(c), depth + 1, max_depth, callback,
                                         private_data);
            }
      }
      tc->flags &= ~TALLOC_FLAG_LOOP;
...
talloc_report_depth_FILE_helper(const void *ptr, int depth, int max_depth, int is_ref, void *_f)
{
      ...
      if (tc->limit && tc->limit->parent == tc) {
            fprintf(f,
                    ...
                    " (max_size = %llu bytes, cur_size = %llu bytes)\n",
                    depth * 4, "", name, (unsigned long long)tc->limit->max_size,
                    (unsigned long long)tc->limit->cur_size);
      }

      if (depth == 0) {
            fprintf(f, "%stalloc report on '%s' (total %6llu bytes in %3llu blocks)\n",
                    (max_depth < 0 ? "full " : ""), name,
                    (unsigned long long)talloc_total_size(ptr),
                    (unsigned long long)talloc_total_blocks(ptr));
            return;
      }

      fprintf(f, "%*s%-30s contains %6llu bytes in %3llu blocks (ref %d) %p\n", depth * 4, "", name,
              (unsigned long long)talloc_total_size(ptr),
              (unsigned long long)talloc_total_blocks(ptr), (int)talloc_reference_count(ptr), ptr);
 ...
 */
_PUBLIC_ void
talloc_report_depth_file(const void *ptr, int depth, int max_depth, FILE *f)
{
      if (f) {
 ...
 */
_PUBLIC_ void
talloc_report_full(const void *ptr, FILE *f)
{
 ...
 */
_PUBLIC_ void
talloc_report(const void *ptr, FILE *f)
{
      talloc_report_depth_file(ptr, 0, 1, f);
}
 ...
 */
_PUBLIC_ void
talloc_enable_null_tracking(void)
{
 ...
 */
_PUBLIC_ void
talloc_enable_null_tracking_no_autofree(void)
{
      if (null_context == NULL)
            null_context = _talloc_named_const(NULL, 0, "null_context");
}
 ...
 */
_PUBLIC_ void
talloc_disable_null_tracking(void)
{
      if (null_context != NULL) {
 ...
 */
_PUBLIC_ void
talloc_enable_leak_report(void)
{
 ...
 */
_PUBLIC_ void
talloc_enable_leak_report_full(void)
{
      talloc_enable_null_tracking();
 ...
 */
_PUBLIC_ void *
_talloc_zero(const void *ctx, size_t size, const char *name)
{
 ...
 */
_PUBLIC_ void *
_talloc_memdup(const void *t, const void *p, size_t size, const char *name)
{
      void *newp = NULL;
...
static inline char *
__talloc_strlendup(const void *t, const char *p, size_t len)
{
      char                   *ret;
      struct talloc_chunk *tc DBG_INITIALIZE_NULL;
 ...
 */
_PUBLIC_ char *
talloc_strdup(const void *t, const char *p)
{
      if (unlikely(!p))
            return NULL;
...
static inline char *
__talloc_strlendup_append(char *s, size_t slen, const char *a, size_t alen)
{
      char *ret;
...
static struct talloc_chunk *
_vasprintf_tc(const void *t, const char *fmt, va_list ap)
{
      int                     vlen;
      size_t                  len;
      char                   *ret;
...
static inline char *__talloc_vaslenprintf_append(char *s, size_t slen, const char *fmt, va_list ap)
    PRINTF_ATTRIBUTE(3, 0);

static inline char *
__talloc_vaslenprintf_append(char *s, size_t slen, const char *fmt, va_list ap)
{
      ssize_t alen;
      va_list ap2;
      char    c;
 ...
 */
_PUBLIC_ char *
talloc_vasprintf_append_buffer(char *s, const char *fmt, va_list ap)
{
      size_t slen;
 ...
 */
_PUBLIC_ void *
_talloc_array(const void *ctx, size_t el_size, unsigned count, const char *name)
{
 ...
 */
_PUBLIC_ void *
_talloc_zero_array(const void *ctx, size_t el_size, unsigned count, const char *name)
{
      if (count >= MAX_TALLOC_SIZE / el_size)
            return NULL;
...
static int
talloc_autofree_destructor(__attribute__((unused)) void *ptr)
{
...
_PUBLIC_ size_t
talloc_get_size(const void *context)
{
      struct talloc_chunk *tc;
 ...
 */
_PUBLIC_ void *
talloc_find_parent_byname(const void *context, const char *name)
{
      struct talloc_chunk *tc;
 ...
 */
_PUBLIC_ void
talloc_show_parents(const void *context, FILE *file)
{
      struct talloc_chunk *tc;
 ...
 */
static int
_talloc_is_parent(const void *context, const void *ptr, int depth)
{
      struct talloc_chunk *tc;
 ...
 */
_PUBLIC_ int
talloc_is_parent(const void *context, const void *ptr)
{
 ...
 */
static inline size_t
_talloc_total_limit_size(const void             *ptr,
                         struct talloc_memlimit *old_limit,
                         struct talloc_memlimit *new_limit)
{
...
static inline bool
talloc_memlimit_check(struct talloc_memlimit *limit, size_t size)
{
      struct talloc_memlimit *l;

      for (l = limit; l != NULL; l = l->upper) {
            if (l->max_size != 0 &&
                ((l->max_size <= l->cur_size) || (l->max_size - l->cur_size < size)))
                  return false;
      }
 ...
 */
static void
tc_memlimit_update_on_free(struct talloc_chunk *tc)
{
 ...
 */
static void
talloc_memlimit_grow(struct talloc_memlimit *limit, size_t size)
{
      struct talloc_memlimit *l;
 ...
 */
static void
talloc_memlimit_shrink(struct talloc_memlimit *limit, size_t size)
{
      struct talloc_memlimit *l;
...
_PUBLIC_ int
talloc_set_memlimit(const void *ctx, size_t max_size)
{
